...
namespace ELog.Core.Authorization.Users
{
    public class UserRegistrationManager : DomainService
    {
        ...
        public async Task<User> RegisterExternalAsync(string name, string surname, string emailAddress, string userName, string plainPassword, bool isEmailConfirmed)
        {
            //CheckForTenant();
