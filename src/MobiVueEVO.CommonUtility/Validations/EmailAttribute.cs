...
namespace MobiVUE.Utility.Validations
{
    ...
    public sealed class EmailAttribute : ValidationAttribute
    {
        ...
        {
            if (value.IsNull() || value.ToString().IsNullOrWhiteSpace()) return ValidationResult.Success;
            ...
            return new System.ComponentModel.DataAnnotations.ValidationResult(ErrorMessage ?? "Invalid email address.");
        }
    }
}