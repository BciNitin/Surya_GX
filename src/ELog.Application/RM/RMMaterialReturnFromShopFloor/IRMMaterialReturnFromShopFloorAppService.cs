...
{
    public interface IRMMaterialReturnFromShopFloorAppService : IApplicationService
    {
        public Task<IActionResult> ReturnFromShopFLoor(string Type, string WorkOrder, string BarCode, string SiteCode);
