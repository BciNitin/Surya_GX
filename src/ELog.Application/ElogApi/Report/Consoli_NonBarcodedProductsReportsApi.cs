   ...
   public  class Consoli_NonBarcodedProductsReportsApi : ApplicationService
    {
        ...
        public Consoli_NonBarcodedProductsReportsApi(IConfiguration configuration, ISessionAppService sessionAppService)
        {
        ...
        public async Task<Object> GetConsNonBarcodedProductDetails()
        {
            try
            {
                ...
                using (MySqlCommand Command = new MySqlCommand())
                {
                    ...
                    Command.Parameters.Add("sType", MySqlDbType.VarChar).Value = "ConsNonBarcodedProductDetails";
