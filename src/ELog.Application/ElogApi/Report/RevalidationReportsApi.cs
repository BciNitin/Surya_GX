...
{
   public class RevalidationReportsApi : ApplicationService
    {
        private readonly IConfiguration _configuration;
        private string connection;
        private ISessionAppService _sessionAppService;
        public RevalidationReportsApi(IConfiguration configuration, ISessionAppService sessionAppService)
        {
        ...
        [HttpPost]
        public async Task<Object> GetRevalidationReport([FromBody] RevalidationReports reports)
        {
            try
            {
                ...
                using (MySqlCommand Command = new MySqlCommand())
                {
                    ...
                    Command.Parameters.Add("sType", MySqlDbType.VarChar).Value = "RevalidationReport";
