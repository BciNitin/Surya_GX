...
namespace ELog.Application.ElogApi.Report
{
    ...
    public  class DealerWiseFailureDetailsApi : ApplicationService
    {
        ...
        public DealerWiseFailureDetailsApi(IConfiguration configuration, ISessionAppService sessionAppService)
        {
        ...
        public async Task<Object> GetDealerWiseFailureDetails()
        {
            try
            {
                ...
                using (MySqlCommand Command = new MySqlCommand())
                {
                    ...
                    Command.Parameters.Add("sType", MySqlDbType.VarChar).Value = "DealerWiseFailureDetails";
