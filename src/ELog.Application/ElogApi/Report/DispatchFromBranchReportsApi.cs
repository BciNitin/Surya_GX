...
{
    public class DispatchFromBranchReportsApi : ApplicationService
    {
        private readonly IConfiguration _configuration;
        private string connection;
        private ISessionAppService _sessionAppService;
        public DispatchFromBranchReportsApi(IConfiguration configuration, ISessionAppService sessionAppService)
        {
        ...
        [HttpPost]
        public async Task<Object> GetDispatchFromBranchReport([FromBody] DispatchFromBranchReports reports)
        {
            try
            {
                ...
                using (MySqlCommand Command = new MySqlCommand())
                {
                    ...
                    Command.Parameters.Add("sType", MySqlDbType.VarChar).Value = "DispatchFromBranch";
