...
{
    [PMMSAuthorize]
    public class ManufacturingMonthWiseDefectiveApi: ApplicationService
    {
        private readonly IConfiguration _configuration;
        private string connection;
        private ISessionAppService _sessionAppService;
        public ManufacturingMonthWiseDefectiveApi(IConfiguration configuration, ISessionAppService sessionAppService)
        {
            _configuration = configuration;
            connection = _configuration["ConnectionStrings:Default"];
            _sessionAppService = sessionAppService;
        }
        public async Task<Object> GetManufacturingMonthWiseDefective()
        {
            try
            {
                ...
                using (MySqlCommand Command = new MySqlCommand())
                {
                    ...
                    Command.Parameters.Add("sType", MySqlDbType.VarChar).Value = "ManufacturingMonthWiseDefective";
