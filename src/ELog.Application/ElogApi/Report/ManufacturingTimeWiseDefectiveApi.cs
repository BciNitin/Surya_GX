...
{
   public class ManufacturingTimeWiseDefectiveApi : ApplicationService
    {
        private readonly IConfiguration _configuration;
        private string connection;
        private ISessionAppService _sessionAppService;
        public ManufacturingTimeWiseDefectiveApi(IConfiguration configuration, ISessionAppService sessionAppService)
        {
            _configuration = configuration;
            connection = _configuration["ConnectionStrings:Default"];
            _sessionAppService = sessionAppService;
        }
        public async Task<Object> GetManufacturingTimeWiseDefective()
        {
            try
            {
                ...
                using (MySqlCommand Command = new MySqlCommand())
                {
                    ...
                    Command.Parameters.Add("sType", MySqlDbType.VarChar).Value = "ManufacturingTimeWiseDefective";
