...
namespace ELog.Application.ElogApi.Report
{
    public class AsOnDateInventoryReportsApi: ApplicationService
    {
        ...
        public AsOnDateInventoryReportsApi(IConfiguration configuration, ISessionAppService sessionAppService)
        {
        ...
        [HttpPost]
        public async Task<Object> GetAsOnDateInventoryReport([FromBody] TransferPlantToWarehouseReports reports)
        {
            try
            {
                ...
                using (MySqlCommand Command = new MySqlCommand())
                {
                    ...
                    Command.Parameters.Add("sType", MySqlDbType.VarChar).Value = "AsOnDateInventoryReport";
