...
{
    [PMMSAuthorize]
    public  class NonBarcodedProductsReportsApi : ApplicationService
    {
        private readonly IConfiguration _configuration;
        private string connection;
        private ISessionAppService _sessionAppService;
        public NonBarcodedProductsReportsApi(IConfiguration configuration, ISessionAppService sessionAppService)
        {
        ...
        public async Task<Object> GetNonBarcodedProductDetails()
        {
            try
            {
                ...
                using (MySqlCommand Command = new MySqlCommand())
                {
                    ...
                    Command.Parameters.Add("sType", MySqlDbType.VarChar).Value = "NonBarcodedProductDetails";
