...
namespace MobiVueEVO.DAL
{
    public class SafeDataReader : IDataReader
    {
        ...
        {
            if (_dataReader.IsDBNull(i)) // DateTime.MinValue with other Kind have issue in serialization
                return DateTime.SpecifyKind(SqlDateTime.MinValue.Value, DateTimeKind.Utc);
            else
