...
import { ConfigurationServiceProxy, ChangeUiThemeInput ,ChangePswdServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class RightSideBarComponent extends AppComponentBase implements OnInit {
    ...
    constructor(
        injector: Injector,
        private _changePwdService: ChangePswdServiceProxy,private _configurationService: ConfigurationServiceProxy
    ) {
        super(injector);
    }
