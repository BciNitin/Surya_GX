...
@Component({
  selector: 'app-dealer-wise-failure-details',
  templateUrl: './dealer-wise-failure-details.component.html',
  styleUrls: ['./dealer-wise-failure-details.component.css'],
...
ngOnInit() {
  this.titleService.setTitle('Dealer Wise Failure Details For Month');
...
private getArray() {
      this._apiservice.GetDealerWiseFailureDetails().subscribe(result => {
