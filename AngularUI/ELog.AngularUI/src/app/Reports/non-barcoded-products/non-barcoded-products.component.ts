...
@Component({
  selector: 'app-non-barcoded-products',
  templateUrl: './non-barcoded-products.component.html',
  styleUrls: ['./non-barcoded-products.component.css'],
  animations: [appModuleAnimation()],
  providers: [ValidationService]
})
export class NonBarcodedProductsComponent implements OnInit {
  public array: any;
  challanNo:any;
  IExcel: grid | any;
  exportExcel: any | 0;
...
ngOnInit() {
  this.titleService.setTitle('Non Barcoded Products Report');
...
private getArray() {
      this._apiservice.GetNonBarcodedProductDetails().subscribe(result => {
...
exportexcel(): void {
  this.exportExcel = 1
      ...
      let Heading = [['Srno', 'Dealer Name', 'Branch', 'Item Desc','Offered Quantity','Approved Quantity','Reason','Plant','Vendor','Scan Date']];
      ...
      XLSX.writeFile(wb, 'NonBarcodedProducts.xlsx');
